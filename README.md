...
🔗 (https://library-management-system-mocha-ten.vercel.app/)
...
│   ├── admin/
│   │   ├── borrow/
│   │   │   └── page.js       # Admin Borrow Records Page
│   │   ├── page.js           # Admin Dashboard Homepage
│   │   └── layout.js         # Admin Layout (Sidebar)
│   ├── books/
│   │   ├── [id]/
│   │   │   └── page.js       # Single Book Detail Page
│   │   └── page.js           # All Books Page
│   ├── profile/
│   │   └── page.js           # User Profile & Borrowed Books
│   ├── login/
...
│   ├── api/
│   │   └── borrow/
│   │       └── route.js      # Unused API Route (To Delete)
...
├── data/
│   └── borrows.json          # Unused Local JSON (To Delete)
